...
export function DealForm({
 ...
 className="h-9 w-full rounded-lg border border-border bg-accent px-2.5 text-sm text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-primary"
 >
 ...
 className="min-h-[100px] border-border bg-accent text-foreground"
 />
 </div>
