...
export function QuickActions() {
 ...
 key={a.href}
 href={a.href}
 className="group flex items-center gap-3 rounded-xl border border-border bg-background px-4 py-3 transition-colors hover:border-border hover:bg-accent"
 >
 <div className={`flex h-9 w-9 items-center justify-center rounded-lg bg-accent ${a.tint}`}>
