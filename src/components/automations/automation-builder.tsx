...
function TriggerCard({
 ...
 className="w-full rounded-md border border-border bg-accent px-2 py-1.5 text-sm text-foreground focus:border-primary focus:outline-none"
 >
...
function KeywordMatchConfig({
 ...
 className="w-full rounded-md border border-border bg-accent px-2 py-1.5 text-sm text-foreground focus:outline-none"
 >
...
function StepEditor({
 ...
 className="min-h-24 bg-accent text-foreground"
 />
 </FieldBlock>
 )
 case "send_template":
 ...
 className="min-h-20 bg-accent font-mono text-xs text-foreground"
 />
 </FieldBlock>
 </>
 )
