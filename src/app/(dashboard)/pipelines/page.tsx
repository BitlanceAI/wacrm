...
export default function PipelinesPage() {
 ...
 <div className="h-9 w-28 animate-pulse rounded-lg bg-accent" />
 </div>
 <div className="flex gap-3">
 {[1, 2, 3, 4, 5].map((i) => (
 <div key={i} className="h-96 w-72 animate-pulse rounded-xl bg-accent" />
 ))}
 </div>
 </div>
 );
 ...
 <DropdownMenu>
 <DropdownMenuTrigger
 className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground hover:bg-accent transition-colors data-[popup-open]:bg-accent"
 >
 ...
 className="mt-2 bg-accent border-border text-foreground"
 onKeyDown={(e) => {
